              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group card-premium p-4 flex flex-col h-full relative overflow-hidden bg-white border border-slate-150 hover:border-orange/20 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 rounded-3xl"
                  >
                    {/* Featured Badge */}
                    {isFeatured && (
                      <div className="absolute top-3.5 right-3.5 bg-[#ea580c] text-white text-[7.5px] font-bold px-1.5 py-0.5 rounded-full flex items-center space-x-0.5 uppercase tracking-wider">

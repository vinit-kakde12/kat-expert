  ...
  return (
    <main className="bg-slate-50/50 min-h-screen pb-20 font-sans text-slate-800">
      ...
      <div className="container-x max-w-6xl mx-auto mt-12 px-4">
        {/* Year selectors */}
        <div className="flex flex-wrap gap-2 justify-center mb-10" id="cat-pyq-years-tabs">
          {YEARS.map((y) => {
        ...
        {/* Papers Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="cat-pyqs-grid">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-4xl rounded-2xl bg-white p-4 shadow-2xl flex flex-col h-[85vh]">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-3">
              <div>
                <h3 className="font-display text-sm font-bold text-navy">CAT {selectedPreview.year} — Slot {selectedPreview.slot}</h3>
                <p className="text-[10px] text-muted-foreground">Previous Year Paper Preview</p>
              </div>
              <button
